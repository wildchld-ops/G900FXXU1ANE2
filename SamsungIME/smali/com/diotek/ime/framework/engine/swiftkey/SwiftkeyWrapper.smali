...
.method public checkCurrentSequence(Ljava/lang/StringBuilder;[I[I)V
    ...
    invoke-interface/range {v17 .. v17}, Lcom/diotek/ime/framework/common/InputManager;->isEmptyEditText()Z
    ...
    invoke-interface/range {v17 .. v19}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->getContextCorrentWord(Ljava/lang/String;Ljava/lang/String;)Lcom/touchtype_fluency/ContextCurrentWord;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/touchtype_fluency/ContextCurrentWord;->getCurrentWord()Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/touchtype_fluency/ContextCurrentWord;->getContext()Lcom/touchtype_fluency/Sequence;
    ...
    invoke-virtual/range {v17 .. v18}, Lcom/touchtype_fluency/Sequence;->setType(Lcom/touchtype_fluency/Sequence$Type;)V
    ...
    invoke-interface/range {v17 .. v18}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->setTouchHistory(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v12}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->updateRetrospectiveCorrection(Lcom/touchtype_fluency/Sequence;Lcom/touchtype_fluency/Sequence;)I
    ...
    const-string v18, "SwiftkeyWrapper-checkCurrentSequence : use IC"
    ...
    invoke-interface {v4, v0}, Landroid/view/inputmethod/InputConnection;->getSelectedText(I)Ljava/lang/CharSequence;
    ...
    new-instance v17, Lcom/touchtype_fluency/Sequence;

    invoke-direct/range {v17 .. v17}, Lcom/touchtype_fluency/Sequence;-><init>()V
    ...
    new-instance v17, Lcom/touchtype_fluency/ContextCurrentWord;
    ...
    invoke-direct/range {v17 .. v19}, Lcom/touchtype_fluency/ContextCurrentWord;-><init>(Lcom/touchtype_fluency/Sequence;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v3}, Lcom/touchtype_fluency/ContextCurrentWord;-><init>(Lcom/touchtype_fluency/Sequence;Ljava/lang/String;)V
    ...
    invoke-interface/range {v17 .. v19}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->getContextCorrentWord(Ljava/lang/String;I)Lcom/touchtype_fluency/ContextCurrentWord;
    ...
    new-instance v8, Lcom/touchtype_fluency/WordBreakIterator;

    invoke-direct {v8}, Lcom/touchtype_fluency/WordBreakIterator;-><init>()V
    ...
    invoke-virtual {v8, v0}, Lcom/touchtype_fluency/WordBreakIterator;->setText(Ljava/lang/String;)V

    const/16 v17, 0x0

    invoke-virtual {v8}, Lcom/touchtype_fluency/WordBreakIterator;->next()I
    ...
    invoke-interface/range {v17 .. v17}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->getSwiftKeyVersion()Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyDatatype$SWIFTKEY_VERSION;

    move-result-object v17

    sget-object v18, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyDatatype$SWIFTKEY_VERSION;->SWIFTKEY_VERSION_1_3:Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyDatatype$SWIFTKEY_VERSION;
    ...
    invoke-interface/range {v17 .. v17}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->getTokenizer()Lcom/touchtype_fluency/Tokenizer;

    move-result-object v17

    move-object/from16 v0, v17

    invoke-interface {v0, v11}, Lcom/touchtype_fluency/Tokenizer;->split(Ljava/lang/String;)Lcom/touchtype_fluency/Sequence;
    ...
    invoke-interface/range {v17 .. v18}, Lcom/touchtype_fluency/Tokenizer;->split(Ljava/lang/String;)Lcom/touchtype_fluency/Sequence;
    ...
    invoke-interface/range {v17 .. v18}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->restoredTouchHistory(Ljava/lang/String;)Lcom/touchtype_fluency/TouchHistory;
    ...
    invoke-interface {v0, v15, v1}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->setTouchHistory(Lcom/touchtype_fluency/TouchHistory;Ljava/lang/String;)V
...
.method public getSuggestion(Ljava/util/ArrayList;Z)I
    ...
    iget-boolean v0, v0, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mIsEnableAutoCorrection:Z
    ...
    iget-boolean v0, v0, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mShiftMode:Z

    move/from16 v17, v0

    if-nez v17, :cond_6

    invoke-virtual/range {v16 .. v16}, Lcom/touchtype_fluency/TouchHistory;->size()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/touchtype_fluency/TouchHistory;->toString()Ljava/lang/String;
...
.method public init()I
    ...
    iget-boolean v5, p0, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mInitializeLangaugePack:Z

    if-nez v5, :cond_3

    const/4 v2, 0x0

    sget-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mSwiftkeyNormalManager:Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;

    invoke-interface {v5}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->reset()V

    sget-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mSwiftkeyChineseManager:Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;

    invoke-interface {v5}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->reset()V

    sget-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mSwiftkeyJapaneseManager:Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;
    ...
    const-string v5, "/system/sipdb"

    const-string v6, "zh_TW.zip"
    ...
    sput-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->LANGUAGE_PACK_DB_DIR:Ljava/lang/String;

    sget-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mSwiftkeyNormalManager:Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;

    invoke-direct {p0, v5}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->createSwiftKeySession(Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;)Z
    ...
    invoke-interface {v5, v6}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->getSwiftKeyConfigurationURL(Z)Ljava/lang/String;

    move-result-object v5

    sput-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->SwiftKeyConfigurationURL:Ljava/lang/String;

    invoke-static {}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->getLanguagePackManager()Lcom/touchtype_fluency/util/LanguagePackManager;

    move-result-object v5

    sput-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mLanguagePackManager:Lcom/touchtype_fluency/util/LanguagePackManager;

    if-eqz v2, :cond_0

    sget-object v5, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->mLanguagePackManager:Lcom/touchtype_fluency/util/LanguagePackManager;
    ...
    const-string v5, "Fail to init input engine : NullPointerException"
    ...
    invoke-interface {v5}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyManager;->setExclusionPattern()V
    ...
    invoke-direct {p0, v4}, Lcom/diotek/ime/framework/engine/swiftkey/SwiftkeyWrapper;->loadLanguageModels(Z)V

    :cond_3
    const-string v5, "V1_5"

    const-string v6, "V1_5"
    ...
    invoke-interface {v5}, Lcom/diotek/ime/framework/common/InputManager;->isNeedToRemoveKPMEx()Z
    ...
    invoke-interface {v5, v4}, Lcom/diotek/ime/framework/common/InputManager;->setNeedToRemoveKPMEx(Z)V
...
.method public updateAcuteAccentState(Z)V
    ...
    const/high16 v0, 0x656c

    if-eq v3, v0, :cond_0

    const/high16 v0, 0x6c76
