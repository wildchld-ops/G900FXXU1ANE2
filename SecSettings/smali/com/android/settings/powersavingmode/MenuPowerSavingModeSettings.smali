...
.method private showHelpStep1Dialog()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/helpdialog/TwTouchPunchView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v4, v2}, Landroid/widget/Switch;->getLocationInWindow([I)V
    ...
    invoke-virtual {v4}, Landroid/widget/Switch;->getWidth()I

    move-result v2

    iput v2, v1, Landroid/view/ViewGroup$LayoutParams;->width:I

    invoke-virtual {v4}, Landroid/widget/Switch;->getHeight()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/helpdialog/TwTouchPunchView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v7}, Lcom/android/settings/helpdialog/TwHelpAnimatedDialog;->setShowWrongInputToast(Z)V
...
.method private updateUIPowerSaving()V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mIsFromHelp:Z
    ...
    iget-boolean v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mIsFromHelp:Z

    if-nez v6, :cond_1

    invoke-virtual {p0, v11}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->setHasOptionsMenu(Z)V
    ...
    iput-boolean v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mSupportBrowser:Z

    const v6, 0x7f070075

    invoke-virtual {p0, v6}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->addPreferencesFromResource(I)V
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mActionBarSwitch:Landroid/widget/Switch;
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mActionBarLayout:Landroid/view/View;

    :cond_4
    new-instance v6, Lcom/android/settings/powersavingmode/PowerSavingEnabler;

    iget-object v7, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mActionBarSwitch:Landroid/widget/Switch;

    invoke-direct {v6, v0, v7, v10}, Lcom/android/settings/powersavingmode/PowerSavingEnabler;-><init>(Landroid/content/Context;Landroid/widget/Switch;Z)V

    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingEnabler:Lcom/android/settings/powersavingmode/PowerSavingEnabler;
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mCpuPowerSavinge:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mDisplayPowerSaving:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mBackgroundColor:Landroid/preference/CheckBoxPreference;
    ...
    :cond_5
    const-string v6, "enable_settings"
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mEnableSettings:Landroid/preference/ListPreference;

    iget-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mEnableSettings:Landroid/preference/ListPreference;
    ...
    iget-boolean v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mSupportBrowser:Z
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mOffHapticFeedback:Landroid/preference/CheckBoxPreference;

    const-string v6, "vibrator"

    invoke-virtual {p0, v6}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getString(I)Ljava/lang/String;
    ...
    const-string v6, "power_saving_touchkey"
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mOffTouchKeyLight:Landroid/preference/CheckBoxPreference;

    const-string v6, "power_saving_location"
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mOffLocationService:Landroid/preference/CheckBoxPreference;

    const-string v6, "powersaving_mode_summary"

    invoke-virtual {p0, v6}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v6

    check-cast v6, Lcom/android/settings/UnclickablePreference;

    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowersavingModeSummary:Lcom/android/settings/UnclickablePreference;

    iget-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowersavingModeSummary:Lcom/android/settings/UnclickablePreference;

    invoke-virtual {v6, v4}, Lcom/android/settings/UnclickablePreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowersavingModeSummary:Lcom/android/settings/UnclickablePreference;

    const v7, 0x7f040189

    invoke-virtual {v6, v7}, Lcom/android/settings/UnclickablePreference;->setLayoutResource(I)V

    invoke-virtual {p0}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v6

    iget-object v7, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mOffHapticFeedback:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingModeCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {p0}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v6

    iget-object v7, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingModeCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {v6, v7}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    const-string v6, "power_saving_tips_preference_key"
    ...
    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingTipCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {p0}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v6

    iget-object v7, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingTipCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {v6, v7}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    new-instance v6, Lcom/android/settings/powersavingmode/PowerSavingLocationEnabler;

    iget-object v7, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mOffLocationService:Landroid/preference/CheckBoxPreference;

    invoke-direct {v6, v0, v7}, Lcom/android/settings/powersavingmode/PowerSavingLocationEnabler;-><init>(Landroid/content/Context;Landroid/preference/CheckBoxPreference;)V

    iput-object v6, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingLocationEnabler:Lcom/android/settings/powersavingmode/PowerSavingLocationEnabler;
...
.method public onResume()V
    ...
    iget-object v4, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mActionBarLayout:Landroid/view/View;
    ...
    iput v4, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->iOffTouchKeyLight:I

    invoke-direct {p0}, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->updateUIPowerSaving()V

    iget-object v4, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingEnabler:Lcom/android/settings/powersavingmode/PowerSavingEnabler;
    ...
    iget-object v8, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingObserver:Landroid/database/ContentObserver;
    ...
    iget-object v8, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSaving2014Observer:Landroid/database/ContentObserver;

    invoke-virtual {v4, v7, v5, v8}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    iget-object v4, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mPowerSavingLocationEnabler:Lcom/android/settings/powersavingmode/PowerSavingLocationEnabler;

    invoke-virtual {v4}, Lcom/android/settings/powersavingmode/PowerSavingLocationEnabler;->resume()V
    ...
    const-string v6, "curEnableValue: "
    ...
    const-string v4, "com.sec.android.intent.action.POWER_SAVING_SWITCH"
    ...
    iget-object v5, p0, Lcom/android/settings/powersavingmode/MenuPowerSavingModeSettings;->mReceiver:Landroid/content/BroadcastReceiver;
