...
.method static synthetic access$1400(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)Landroid/content/ContentResolver;
    .locals 1
...
.method static synthetic access$1500(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)Landroid/preference/SwitchPreferenceScreen;
    .locals 1
...
.method static synthetic access$1600(Lcom/android/settings/accessibility/AccessibilitySettingsVision;I)V
    .locals 0
...
.method static synthetic access$3100(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)Z
    .locals 1
...
.method static synthetic access$3300(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)Lcom/android/settings/FontSizeListPreference;
    .locals 1
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    new-instance v1, Lcom/android/settings/accessibility/AccessibilitySettingsVision$10;

    invoke-direct {v1, p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$10;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    new-instance v2, Lcom/android/settings/accessibility/AccessibilitySettingsVision$11;

    invoke-direct {v2, p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$11;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)V
    ...
    new-instance v3, Lcom/android/settings/accessibility/AccessibilitySettingsVision$12;

    invoke-direct {v3, p0, v2, v0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$12;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;Landroid/content/SharedPreferences$Editor;Lcom/sec/android/touchwiz/widget/TwCheckBox;)V
    ...
    new-instance v1, Lcom/android/settings/accessibility/AccessibilitySettingsVision$15;

    invoke-direct {v1, p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$15;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)V

    invoke-virtual {v0, v5, v1}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v0

    new-instance v1, Lcom/android/settings/accessibility/AccessibilitySettingsVision$14;

    invoke-direct {v1, p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$14;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)V
    ...
    new-instance v2, Lcom/android/settings/accessibility/AccessibilitySettingsVision$22;

    invoke-direct {v2, p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision$22;-><init>(Lcom/android/settings/accessibility/AccessibilitySettingsVision;)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->floatToIndex(F)I
    ...
    iget-boolean v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mSupportFolderType:Z
    ...
    invoke-static {v9, v10, v2}, Landroid/provider/Settings$Global;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    sget v9, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->HUGE_FONT_INDEX:I
    ...
    invoke-virtual {v9, v3, v10}, Landroid/app/Activity;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V

    const-string v9, "AccessibilitySettings_Vision"

    const-string v10, "android.settings.FONT_SIZE_CHANGED broadcast. extra(large_font) : 1"
    ...
    const-string v9, "pref_font_noti"
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->showDialog(I)V

    :cond_2
    invoke-virtual {p0, p2}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->writeFontSizePreference(Ljava/lang/Object;)V

    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mFontSizePref:Lcom/android/settings/FontSizeListPreference;

    invoke-virtual {p0, v9}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->readFontSizePreference(Landroid/preference/ListPreference;)V
    ...
    const-string v10, "android.settings.FONT_SIZE_CHANGED broadcast. extra(large_font) : 0"
    ...
    :cond_4
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mNotificationReminder:Landroid/preference/SwitchPreferenceScreen;
    ...
    const-string v9, "notification reminder"
    ...
    const-string v10, "Notification Reminder service could not start"
    ...
    const-string v9, "NotificationReminder"

    const-string v10, "NotificationReminder Service Stop!!"
    ...
    :cond_9
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mColorBlind:Landroid/preference/SwitchPreferenceScreen;
    ...
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mHighContrastCheckbox:Landroid/preference/CheckBoxPreference;
    ...
    const-string v10, "com.samsung.android.app.colorblind"

    const-string v11, "com.samsung.android.app.colorblind.ColorChipStart"

    invoke-direct {v9, v10, v11}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4, v9}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    iget-boolean v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->checkSetupWizard:Z
    ...
    const-string v9, "fromAccessibility"
    ...
    invoke-virtual {p0, v4, v9}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    const-string v9, "com.android.settings.ACTION_COLORBLIND_SWITCH_ON"
    ...
    :cond_f
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mDisplayMagnificationPreferenceScreen:Landroid/preference/SwitchPreferenceScreen;
    ...
    const-string v11, "ACCESSIBILITY_DISPLAY_MAGNIFICATION_ENABLED Use : "
    ...
    :cond_1b
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mGlobalGesturePreferenceScreen:Landroid/preference/SwitchPreferenceScreen;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    :cond_0
    iget-boolean v7, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mOpenDetailMenu:Z

    if-eqz v7, :cond_1

    sget v7, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mSettingValue:I
    ...
    :cond_4
    iget-object v7, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mDisplayMagnificationPreferenceScreen:Landroid/preference/SwitchPreferenceScreen;
    ...
    const-string v6, "AccessibilitySettings_Vision"

    const-string v7, "updateExclusiveTalkback : Rapid key input on"
    ...
    const-string v7, "rapid_key_input_menu_checked"
    ...
    const-string v7, "updateExclusiveTalkback : Rapid key input off"
    ...
    :try_start_0
    invoke-interface {v2, v5}, Landroid/view/accessibility/IAccessibilityManager;->setmDNIeNegative(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-boolean v6, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->checkSetupWizard:Z

    if-nez v6, :cond_d

    iget-object v5, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mColorBlind:Landroid/preference/SwitchPreferenceScreen;

    const-string v6, "com.android.settings.colorblind.ColorChipReport"

    invoke-virtual {v5, v6}, Landroid/preference/SwitchPreferenceScreen;->setFragment(Ljava/lang/String;)V
    ...
    const-string v8, "com.samsung.android.app.colorblind.ColorChipReport"

    invoke-direct {v6, v7, v8}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v3, v6}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    const-string v6, "toStartActivity"

    const-string v7, "fromSetting"
    ...
    :cond_e
    invoke-virtual {p0, v3}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->startActivity(Landroid/content/Intent;)V
...
.method public onResume()V
    ...
    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mSettingsPackageMonitor:Lcom/android/internal/content/PackageMonitor;
    ...
    invoke-virtual {v9, v10, v11, v8}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V

    iget-object v9, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mSettingsContentObserver:Lcom/android/settings/accessibility/SettingsContentObserver;

    invoke-virtual {p0}, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v10

    invoke-virtual {v9, v10}, Lcom/android/settings/accessibility/SettingsContentObserver;->register(Landroid/content/ContentResolver;)V
    ...
    iget-object v11, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mMagnification:Landroid/database/ContentObserver;

    invoke-virtual {v9, v10, v8, v11}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    ...
    iget-object v11, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mColorBlindObserver:Landroid/database/ContentObserver;
    ...
    iget-object v11, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mNegativeColorObserver:Landroid/database/ContentObserver;
    ...
    iget-object v11, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mNotificationReminderObserver:Landroid/database/ContentObserver;
    ...
    iget-object v11, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mGlobalGestureObserver:Landroid/database/ContentObserver;
    ...
    invoke-virtual {v9, v12}, Landroid/preference/SwitchPreferenceScreen;->setSummary(I)V
    ...
    iget-object v10, p0, Lcom/android/settings/accessibility/AccessibilitySettingsVision;->mLcdCurtain:Landroid/preference/CheckBoxPreference;
    ...
    :goto_e
    invoke-virtual {v9, v7}, Landroid/preference/SwitchPreferenceScreen;->setChecked(Z)V
    ...
    invoke-virtual {v9, v13}, Landroid/preference/SwitchPreferenceScreen;->setSummary(I)V
