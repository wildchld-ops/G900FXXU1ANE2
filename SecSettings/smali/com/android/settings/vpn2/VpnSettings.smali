...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v10, p0, Lcom/android/settings/vpn2/VpnSettings;->mVpnPolicy:Landroid/app/enterprise/VpnPolicy;

    const/4 v11, 0x1

    invoke-virtual {v10, v11}, Landroid/app/enterprise/VpnPolicy;->isUserAddProfilesAllowed(Z)Z
    ...
    invoke-virtual {v10}, Lcom/android/settings/vpn2/VpnDialog;->getProfile()Lcom/android/internal/net/VpnProfile;
    ...
    invoke-virtual {v10, v11}, Landroid/app/enterprise/VpnPolicy;->isUserChangeProfilesAllowed(Z)Z

    move-result v10

    if-nez v10, :cond_3

    iget-object v9, v7, Lcom/android/internal/net/VpnProfile;->username:Ljava/lang/String;

    iget-object v5, v7, Lcom/android/internal/net/VpnProfile;->password:Ljava/lang/String;

    iget-boolean v8, v7, Lcom/android/internal/net/VpnProfile;->saveLogin:Z
    ...
    iput-object v9, v7, Lcom/android/internal/net/VpnProfile;->username:Ljava/lang/String;

    iput-boolean v8, v7, Lcom/android/internal/net/VpnProfile;->saveLogin:Z
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/vpn2/VpnSettings;->disconnect(Ljava/lang/String;)V
    ...
    const-string v10, "/data/tbased/iwlandrunning"
    ...
    const v11, 0x7f091312

    invoke-virtual {v10, v11}, Landroid/app/AlertDialog$Builder;->setMessage(I)Landroid/app/AlertDialog$Builder;

    move-result-object v10

    const v11, 0x7f091311

    new-instance v12, Lcom/android/settings/vpn2/VpnSettings$1;

    invoke-direct {v12, p0}, Lcom/android/settings/vpn2/VpnSettings$1;-><init>(Lcom/android/settings/vpn2/VpnSettings;)V
    ...
    invoke-direct {v6, v10, v7}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;-><init>(Landroid/content/Context;Lcom/android/internal/net/VpnProfile;)V
    ...
    invoke-static {v10, v11, v3}, Landroid/util/secutil/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
