...
.method private popupMessage()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method private updateSupprtingfeautresMenu()V
    .locals 5

    const v0, 0x7f0400b7

    invoke-virtual {p0, v0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->setContentView(I)V

    const v0, 0x7f0b0213

    invoke-virtual {p0, v0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/TextView;

    iput-object v0, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mMessage:Landroid/widget/TextView;

    const-string v0, "support_samsung_account"

    iget-object v1, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mPreviousStage:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getActionBar()Landroid/app/ActionBar;
    ...
    iget-object v0, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mMessage:Landroid/widget/TextView;
    ...
    const-string v4, "#2898c4"

    aput-object v4, v2, v3

    invoke-virtual {p0, v1, v2}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->startActivityForResult(Landroid/content/Intent;I)V
    :try_end_1
...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->startActivityForResult(Landroid/content/Intent;I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getApplicationContext()Landroid/content/Context;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mContext:Landroid/content/Context;

    new-instance v3, Lcom/android/internal/widget/LockPatternUtils;

    invoke-direct {v3, p0}, Lcom/android/internal/widget/LockPatternUtils;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v3, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mFingerprintManager:Lcom/samsung/android/fingerprint/FingerprintManager;

    new-instance v3, Landroid/widget/Switch;

    invoke-direct {v3, p0}, Landroid/widget/Switch;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mActionBarSwitch:Landroid/widget/Switch;
    ...
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->getIntent()Landroid/content/Intent;
    ...
    iput-object v3, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mPreviousStage:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->mPreviousStage:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->updateSupprtingfeautresMenu()V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/settings/fingerprint/FingerprintSupportingFeatures;->finish()V
