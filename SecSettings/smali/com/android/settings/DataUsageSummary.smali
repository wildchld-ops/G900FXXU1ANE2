...
.method static synthetic access$1200(Lcom/android/settings/DataUsageSummary;)Landroid/app/DialogFragment;
    .locals 1
...
.method static synthetic access$1202(Lcom/android/settings/DataUsageSummary;Landroid/app/DialogFragment;)Landroid/app/DialogFragment;
    .locals 0
...
.method static synthetic access$1400(Lcom/android/settings/DataUsageSummary;)Landroid/app/enterprise/RestrictionPolicy;
    .locals 1
...
.method static synthetic access$1700(Lcom/android/settings/DataUsageSummary;)Lcom/sec/android/touchwiz/widget/TwCheckBox;
    .locals 1
...
.method static synthetic access$1800(Lcom/android/settings/DataUsageSummary;J)V
    .locals 0
...
.method static synthetic access$1900(Lcom/android/settings/DataUsageSummary;)Lcom/sec/android/touchwiz/widget/TwCheckBox;
    .locals 1
...
.method static synthetic access$2100(Lcom/android/settings/DataUsageSummary;)Landroid/content/Intent;
    .locals 1
...
.method static synthetic access$2200(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/UidDetailProvider;
    .locals 1
...
.method static synthetic access$2300(Lcom/android/settings/DataUsageSummary;)Landroid/widget/Spinner;
    .locals 1
...
.method static synthetic access$2400(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/widget/ChartDataUsageView;
    .locals 1
...
.method static synthetic access$2600(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsSession;
    .locals 1
...
.method static synthetic access$2900(Lcom/android/settings/DataUsageSummary;)Landroid/widget/ListView;
    .locals 1
...
.method static synthetic access$300(Lcom/android/settings/DataUsageSummary;)Landroid/app/ProgressDialog;
    .locals 1
...
.method static synthetic access$302(Lcom/android/settings/DataUsageSummary;Landroid/app/ProgressDialog;)Landroid/app/ProgressDialog;
    .locals 0
...
.method static synthetic access$3400(Landroid/content/Context;J)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3500(Landroid/content/Context;J)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3602(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/DataUsageSummary$AppItem;)Lcom/android/settings/DataUsageSummary$AppItem;
    .locals 0
...
.method static synthetic access$400(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsService;
    .locals 1
...
.method static synthetic access$4300(Lcom/android/settings/DataUsageSummary;)V
    .locals 0
...
.method static synthetic access$4400(Lcom/android/settings/DataUsageSummary;)V
    .locals 0
...
.method static synthetic access$4500(Lcom/android/settings/DataUsageSummary;)Z
    .locals 1
...
.method static synthetic access$600(Lcom/android/settings/DataUsageSummary;)Landroid/widget/TabHost;
    .locals 1
...
.method static synthetic access$700(Lcom/android/settings/DataUsageSummary;)Landroid/net/NetworkPolicyManager;
    .locals 1
...
.method static synthetic access$800(Lcom/android/settings/DataUsageSummary;)Landroid/os/Handler;
    .locals 1
...
.method private updateAppDetail()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/DataUsageSummary$CycleAdapter;->setChangeVisible(Z)V

    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->mChart:Lcom/android/settings/widget/ChartDataUsageView;

    invoke-virtual {v0, v13}, Lcom/android/settings/widget/ChartDataUsageView;->bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    invoke-virtual {v0, v6, v1}, Lcom/android/settings/net/UidDetailProvider;->getUidDetail(IZ)Lcom/android/settings/net/UidDetail;

    move-result-object v0

    iget-object v7, p0, Lcom/android/settings/DataUsageSummary;->mAppIcon:Landroid/widget/ImageView;

    iget-object v8, v0, Lcom/android/settings/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v7, v0, Lcom/android/settings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/DataUsageSummary$CycleAdapter;->setChangeVisible(Z)V
    ...
    iget-object v0, v0, Lcom/android/settings/net/UidDetail;->label:Ljava/lang/CharSequence;

    invoke-static {v5, v8, v0}, Lcom/android/settings/DataUsageSummary;->inflateAppTitle(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Ljava/lang/CharSequence;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->mAppSettingsIntent:Landroid/content/Intent;
    ...
    invoke-virtual {v4, v8, v2}, Landroid/content/pm/PackageManager;->resolveActivity(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    new-instance v1, Lcom/android/settings/DataUsageSummary$6;

    invoke-direct {v1, p0}, Lcom/android/settings/DataUsageSummary$6;-><init>(Lcom/android/settings/DataUsageSummary;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {v3, p0}, Lcom/android/settings/DataUsageSummary$8;-><init>(Lcom/android/settings/DataUsageSummary;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-static {v11, v12, v3}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-static {v1, v10}, Landroid/util/secutil/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v10, p0, Lcom/android/settings/DataUsageSummary;->mMenuAutoSync:Landroid/view/MenuItem;
    ...
    iget-object v10, p0, Lcom/android/settings/DataUsageSummary;->mMenuDataRoaming:Landroid/view/MenuItem;
    ...
    invoke-static {v7}, Lcom/android/settings/DataUsageSummary;->hasReadyMobile4gRadio(Landroid/content/Context;)Z
    ...
    invoke-static {v7}, Lcom/android/settings/DataUsageSummary;->hasWifiRadio(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/DataUsageSummary;->hasEthernet(Landroid/content/Context;)Z
...
.method public onResume()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/settings/DataUsageSummary$7;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public setRestrictBackground(Z)V
    ...
    new-instance v1, Lcom/android/settings/DataUsageSummary$11;

    invoke-direct {v1, p0, p1}, Lcom/android/settings/DataUsageSummary$11;-><init>(Lcom/android/settings/DataUsageSummary;Z)V
