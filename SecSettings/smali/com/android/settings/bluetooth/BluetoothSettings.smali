...
.method private updateContent(IZ)V
    ...
    invoke-virtual {v3, v1}, Landroid/preference/PreferenceScreen;->setOrderingAsAdded(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/preference/PreferenceCategory;->setPersistent(Z)V
    ...
    invoke-direct {v0, v5, v6}, Lcom/android/settings/bluetooth/BluetoothProgressCategory;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method addPreferencesForActivity()V
    ...
    const-string v6, "onCreate : Set Switch padding 0"
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-static {v0}, Lcom/android/settings/Utils;->changeDeviceName(Landroid/app/Activity;)V
...
.method public onResume()V
    ...
    sput-boolean v3, Lcom/android/settings/bluetooth/BluetoothSettings;->mIsDeviceProfileShown:Z
    ...
    const-string v2, "before showing help dialog in tablet + isHelpDialogHidden = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->isHelpDialogHidden:Z
    ...
    iput-boolean v3, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->isHelpDialogHidden:Z
    ...
    const-string v1, "showing help dialog in tablet failed"
    ...
    iput-boolean v3, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->mShowVisibileTimeoutFragment:Z
