...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/accounts/AuthenticatorHelper;Landroid/app/admin/DevicePolicyManager;)V
    ...
    iput-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mWifiEnabler:Lcom/android/settings/wifi/WifiEnabler;
    ...
    iput-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mBluetoothEnabler:Lcom/android/settings/bluetooth/BluetoothEnabler;
    ...
    iput-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mAirplaneModeSwitchEnabler:Lcom/android/settings/AirplaneModeSwitchEnabler;
...
.method private updateCommonHeaderView(Landroid/preference/PreferenceActivity$Header;Lcom/android/settings/GridSettings$HeaderAdapter$HeaderViewHolder;)V
    ...
    invoke-static {}, Lcom/android/settings/GridSettings;->access$500()Landroid/content/Context;
    ...
    iput v3, p1, Landroid/preference/PreferenceActivity$Header;->titleRes:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    const-wide/32 v9, 0x7f0b0689

    cmp-long v7, v7, v9

    if-nez v7, :cond_1

    iget-object v7, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mWifiEnabler:Lcom/android/settings/wifi/WifiEnabler;

    iget-object v8, v4, Lcom/android/settings/GridSettings$HeaderAdapter$HeaderViewHolder;->switch_:Landroid/widget/Switch;

    invoke-virtual {v7, v8}, Lcom/android/settings/wifi/WifiEnabler;->setSwitch(Landroid/widget/Switch;)V
    ...
    :cond_1
    iget-object v7, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mBluetoothEnabler:Lcom/android/settings/bluetooth/BluetoothEnabler;

    iget-object v8, v4, Lcom/android/settings/GridSettings$HeaderAdapter$HeaderViewHolder;->switch_:Landroid/widget/Switch;

    invoke-virtual {v7, v8}, Lcom/android/settings/bluetooth/BluetoothEnabler;->setSwitch(Landroid/widget/Switch;)V
    ...
    const-wide/32 v9, 0x7f0b068d

    cmp-long v7, v7, v9

    if-nez v7, :cond_7

    iget-object v7, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mAirplaneModeSwitchEnabler:Lcom/android/settings/AirplaneModeSwitchEnabler;

    iget-object v8, v4, Lcom/android/settings/GridSettings$HeaderAdapter$HeaderViewHolder;->check_:Lcom/sec/android/touchwiz/widget/TwCheckBox;

    invoke-virtual {v7, v8}, Lcom/android/settings/AirplaneModeSwitchEnabler;->setCheckBox(Lcom/sec/android/touchwiz/widget/TwCheckBox;)V
...
.method public pause()V
    ...
    iget-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mWifiEnabler:Lcom/android/settings/wifi/WifiEnabler;

    invoke-virtual {v0}, Lcom/android/settings/wifi/WifiEnabler;->pause()V

    iget-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mBluetoothEnabler:Lcom/android/settings/bluetooth/BluetoothEnabler;

    invoke-virtual {v0}, Lcom/android/settings/bluetooth/BluetoothEnabler;->pause()V

    iget-object v0, p0, Lcom/android/settings/GridSettings$HeaderAdapter;->mAirplaneModeSwitchEnabler:Lcom/android/settings/AirplaneModeSwitchEnabler;
