...
.method public constructor <init>(Landroid/webkitsec/WebViewClassic;)V
    ...
    invoke-virtual {p0, v7}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->setClippingEnabled(Z)V
    ...
    invoke-virtual {p0, v7}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->setContentView(Landroid/view/View;)V
...
.method public hide()V
    ...
    invoke-virtual {p0}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->dismiss()V
...
.method public show(Landroid/graphics/Point;Landroid/graphics/Point;II)V
    ...
    #calls: Landroid/webkitsec/WebViewClassic;->ensureSelectionHandles()V
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->isShowing()Z
    ...
    invoke-virtual {p0, v4, v5, v2, v3}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->showAtLocation(Landroid/view/View;III)V

    :cond_2
    invoke-virtual {p0, v2, v3, v1, v0}, Landroid/webkitsec/WebViewClassic$PastePopupWindow;->update(IIII)V
