...
.method static getInvitationText(Landroid/content/res/Resources;Lcom/android/services/telephony/common/RcsTransferConstants$SessionType;)Ljava/lang/CharSequence;
    .locals 2

    sget-object v0, Lcom/android/incallui/rcs/RcsShareUI$3;->$SwitchMap$com$android$services$telephony$common$RcsTransferConstants$SessionType:[I
...
.method public static setupInviteCallCardButtons(Landroid/content/Context;Lcom/android/incallui/rcs/RcsInvitation;Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/incallui/rcs/RcsInvitation;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p1, v1}, Lcom/android/incallui/rcs/RcsInvitation;->findViewById(I)Landroid/view/View;
...
.method public static setupRcsCallCard(Landroid/content/Context;Lcom/android/incallui/rcs/RcsInvitation;Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/incallui/rcs/RcsInvitation;->findViewById(I)Landroid/view/View;
    ...
    invoke-static {v0, v1}, Lcom/android/incallui/rcs/RcsShareUI;->getCallerName(Landroid/content/Context;Lcom/android/services/telephony/common/Call;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/incallui/rcs/RcsShareUI;->getPhoneNumber(Landroid/content/Context;Lcom/android/services/telephony/common/Call;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/incallui/rcs/RcsShareUI;->getCallStartTime(Landroid/content/Context;Lcom/android/services/telephony/common/Call;)J

    move-result-wide v2

    sget-object v12, Lcom/android/incallui/rcs/RcsShareUI;->LOG_TAG:Ljava/lang/String;

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "setupRcsCallCard "
    ...
    invoke-static {v12}, Lcom/android/incallui/rcs/RcsShareUI;->acquireSessionInfo(Landroid/content/Context;)Lcom/android/incallui/rcs/RcsShareUI$SessionState;

    move-result-object v10

    iget-boolean v12, v10, Lcom/android/incallui/rcs/RcsShareUI$SessionState;->mIsActive:Z

    if-eqz v12, :cond_1

    iget v12, v10, Lcom/android/incallui/rcs/RcsShareUI$SessionState;->mState:I
    ...
    const-string v13, "RcsCallCard hasInvite"
    ...
    invoke-static/range {p0 .. p2}, Lcom/android/incallui/rcs/RcsShareUI;->setupInviteCallCardButtons(Landroid/content/Context;Lcom/android/incallui/rcs/RcsInvitation;Lcom/android/services/telephony/common/Call;)V
    ...
    iget v12, v10, Lcom/android/incallui/rcs/RcsShareUI$SessionState;->mType:I

    invoke-static {v12}, Lcom/android/services/telephony/common/RcsTransferConstants$SessionType;->getFromInt(I)Lcom/android/services/telephony/common/RcsTransferConstants$SessionType;

    move-result-object v11

    invoke-static {v9, v11}, Lcom/android/incallui/rcs/RcsShareUI;->getInvitationText(Landroid/content/res/Resources;Lcom/android/services/telephony/common/RcsTransferConstants$SessionType;)Ljava/lang/CharSequence;

    move-result-object v12

    invoke-virtual {v8, v12}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    sget-object v12, Lcom/android/incallui/rcs/RcsShareUI$3;->$SwitchMap$com$android$services$telephony$common$RcsTransferConstants$SessionType:[I

    invoke-virtual {v11}, Lcom/android/services/telephony/common/RcsTransferConstants$SessionType;->ordinal()I
    ...
    iget-wide v0, v10, Lcom/android/incallui/rcs/RcsShareUI$SessionState;->mSize:J
    ...
    const-string v13, "RcsCallCard has no invites"
