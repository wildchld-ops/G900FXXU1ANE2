...
.method private checkStorageMemorySpace(Z)Z
    ...
    const-string v14, "Memory Size Avialable is in Kb : "
...
.method private updateUi(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-virtual {v11}, Lcom/android/incallui/InCallPresenter;->getRecorderMgr()Lcom/android/incallui/PhoneVoiceRecorderManager;
    ...
    invoke-virtual {v7}, Lcom/android/incallui/PhoneVoiceRecorderManager;->isPaused()Z

    move-result v11

    if-eqz v11, :cond_4

    invoke-virtual {v7}, Lcom/android/incallui/PhoneVoiceRecorderManager;->resumeRecord()V
    ...
    invoke-interface {v10, v11}, Lcom/android/incallui/CallButtonPresenter$CallButtonUi;->showGroupCall(Z)V
    ...
    invoke-interface {v11}, Lcom/android/incallui/CallButtonPresenter$CallButtonUi;->updateDiapadButton()V
    ...
    :cond_a
    invoke-interface {v10, v6}, Lcom/android/incallui/CallButtonPresenter$CallButtonUi;->setVisible(Z)V
    ...
    invoke-virtual {v7}, Lcom/android/incallui/PhoneVoiceRecorderManager;->pauseRecord()V
...
.method public addCallClicked()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/CallCommandClient;->addCallMultiSim(I)V
...
.method public endCallClicked()V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/incallui/CallButtonPresenter;->log(Ljava/lang/String;Z)V
    ...
    invoke-interface {v1, v2}, Lcom/android/incallui/CallButtonPresenter$CallButtonUi;->displayDialpad(Z)V
...
.method public handleCameraStartFailed()V
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/android/incallui/vt/VideoCallManager;->isCameraRestricted()Z
...
.method public toogleHold()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/incallui/CallCommandClient;->holdMultiSim(I)V
