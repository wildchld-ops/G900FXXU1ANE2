...
.method private DisplayWaitingCallDialogWhenDoNotHaveHoldingCall()V
    ...
    invoke-virtual {v10}, Lcom/google/common/collect/ImmutableSortedSet;->size()I
...
.method private DisplayWaitingCallDialogWhenHaveHoldingCall()V
    ...
    invoke-virtual {v13}, Lcom/google/common/collect/ImmutableSortedSet;->size()I
...
.method private processIncomingCall(Lcom/android/services/telephony/common/Call;)V
    ...
    const-string v6, "[DRIVELINK] audioMode : "
    ...
    invoke-virtual {v0, v4, p0}, Lcom/android/incallui/CallList;->addCallUpdateListener(ILcom/android/incallui/CallList$CallUpdateListener;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/incallui/CallList;->getTextResponses(I)Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v4}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->configureMessageDialog(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v0, v4}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->configureRejectCallWithMessageSlidingDrawer(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/incallui/cover/CoverCall;->configureRejectCallWithMessageSlidingDrawer(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/incallui/CallList;->getIconResponses(I)Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v4}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->configureRejectCallIconMode(Ljava/util/ArrayList;)V
...
.method private showCallRoamingGuardDialog(Lcom/android/services/telephony/common/Call;)V
    ...
    const-string v4, "showCallRoamingGuardDialog : "
    ...
    invoke-virtual {v3}, Lcom/android/incallui/CallCommandClient;->isRoamingSettingInService()Z
    ...
    invoke-virtual {v3}, Lcom/android/incallui/CallCommandClient;->isDomesticRoamingSettingInService()Z
    ...
    invoke-interface {v2, v0}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->showCallRoamingGuardDialog(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lcom/android/incallui/CallCommandClient;->isInternationalRoamingSettingInService()Z
    ...
    invoke-virtual {v3}, Lcom/android/incallui/CallCommandClient;->isInternationalRoamingSettingInServiceGsm()Z
...
.method public onAcceptByVoiceCall()V
    ...
    const-class v2, Lcom/android/incallui/WaitingVoiceCallActivity;
...
.method public onAnswerWithWaitingCheck()V
    ...
    invoke-virtual {v1}, Lcom/android/incallui/CallList;->isDualConversationState()Z
    ...
    invoke-virtual {v1}, Lcom/android/incallui/CallList;->isDualInComingCallState()Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/incallui/CallCommandClient;->answerCall(I)V
    ...
    invoke-virtual {v1}, Lcom/android/incallui/InCallDUOSUIControl;->holdOtherThenAnswer()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/incallui/InCallDUOSUIControl;->duosAnswerCall(Lcom/android/services/telephony/common/Call;)V
...
.method public onCallStateChanged(Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-interface {v0, v2}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->showRejectCallWithMessage(Z)V
    ...
    invoke-interface {v0, v2}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->showAnswerUi(Z)V
...
.method public onDisconnect(Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-static {}, Lcom/android/incallui/AnswerMemoUtils;->stopAnswerMemo()V

    invoke-static {v3}, Lcom/android/incallui/AnswerMemoUtils;->setAutoAnswered(Z)V
...
.method public onHangUpThenAnswer(Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/CallCommandClient;->hangUp(I)V
...
.method public onUiReady(Lcom/android/incallui/AnswerPresenter$AnswerUi;)V
    ...
    invoke-interface {v2, v4}, Lcom/android/incallui/AnswerPresenter$AnswerUi;->showRejectCallWithMessage(Z)V
...
.method public onUiResume()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/incallui/CallList;->getFirstCall(I)Lcom/android/services/telephony/common/Call;
    ...
    const-string v1, "onUiResume() => Update incoming process for duos"
...
.method public onVTRejectWithMsgButton()V
    ...
    const-string v1, "onVTRejectWithMsgButton "
