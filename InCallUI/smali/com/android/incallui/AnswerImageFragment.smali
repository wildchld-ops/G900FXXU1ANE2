...
.method static synthetic access$100(Lcom/android/incallui/AnswerImageFragment;)Landroid/widget/SlidingDrawer;
    .locals 1

    iget-object v0, p0, Lcom/android/incallui/AnswerImageFragment;->mRejectCallWithMsgDrawer:Landroid/widget/SlidingDrawer;
...
.method private setDescription(Landroid/view/View;Z)V
    ...
    iget-object v2, p0, Lcom/android/incallui/AnswerImageFragment;->mRejectCallWithMsgDrawer:Landroid/widget/SlidingDrawer;
...
.method private updateLayout(Z)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/incallui/RejectCallWithMessageContentIconMode;->setVisibility(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/RejectCallWithMessageContent;->setVisibility(I)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/incallui/RejectCallWithMessageContent;->setVisibility(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/RejectCallWithMessageContentIconMode;->setVisibility(I)V
...
.method public onDestroyView()V
    ...
    iput-object v2, p0, Lcom/android/incallui/AnswerImageFragment;->mRejectCallWithMsgDrawer:Landroid/widget/SlidingDrawer;
...
.method protected onFinishInflate(Landroid/view/View;)V
    ...
    iput-object v1, p0, Lcom/android/incallui/AnswerImageFragment;->mRejectCallWithMsgDrawer:Landroid/widget/SlidingDrawer;

    iget-object v1, p0, Lcom/android/incallui/AnswerImageFragment;->mRejectCallWithMsgDrawer:Landroid/widget/SlidingDrawer;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/AnswerImageFragment;->getActivity()Landroid/app/Activity;
...
.method public onTrigger(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/incallui/AnswerImageFragment;->log(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/incallui/AnswerImageFragment;->showAnswerUi(Z)V

    invoke-static {}, Lcom/android/incallui/CallButtonPresenter;->getInstance()Lcom/android/incallui/CallButtonPresenter;

    move-result-object v1

    invoke-virtual {v1, v3}, Lcom/android/incallui/CallButtonPresenter;->setButtonsVisibility(Z)V
    ...
    invoke-interface {v1, v3}, Lcom/android/incallui/CallCardPresenter$CallCardUi;->showMenu(Z)V
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/incallui/CallCommandClient;->answerMessage(IZ)V

    :cond_2
    invoke-virtual {p0}, Lcom/android/incallui/AnswerImageFragment;->getPresenter()Lcom/android/incallui/Presenter;
...
.method public rejectWithAnswerMemo()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/incallui/AnswerImageFragment;->log(Ljava/lang/String;Z)V
...
.method public updateIncomingCallWidgetLayout()V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/AnswerImageFragment;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v7}, Lcom/android/incallui/widget/incomingwidget/IncomingCallImageWidget;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v7, v3}, Lcom/android/incallui/widget/incomingwidget/IncomingCallImageWidget;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
