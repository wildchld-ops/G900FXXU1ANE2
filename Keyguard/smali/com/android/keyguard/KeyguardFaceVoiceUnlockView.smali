...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$5;

    invoke-direct {v0, p0}, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$5;-><init>(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)V
...
.method static synthetic access$1000(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Landroid/widget/FrameLayout;
    .locals 1

    iget-object v0, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mRootLayout:Landroid/widget/FrameLayout;

    return-object v0
.end method

.method static synthetic access$1100(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Landroid/widget/TextView;
    .locals 1

    iget-object v0, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mEmergencyCircleText:Landroid/widget/TextView;

    return-object v0
.end method

.method static synthetic access$1200(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Landroid/widget/Button;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic access$1400(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Z
    .locals 1
...
.method static synthetic access$1402(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;Z)Z
    .locals 0
...
.method static synthetic access$1500(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mContext:Landroid/content/Context;
...
.method private initializeBiometricUnlockView()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->findViewById(I)Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mContext:Landroid/content/Context;
    ...
    new-instance v1, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$4;

    invoke-direct {v1, p0}, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$4;-><init>(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)V
...
.method private maybeStartBiometricUnlock()V
    ...
    iget-object v4, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mContext:Landroid/content/Context;
...
.method protected onFinishInflate()V
    ...
    iget-object v2, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1}, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->findViewById(I)Landroid/view/View;
    ...
    iput-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mRootLayout:Landroid/widget/FrameLayout;

    iget-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mRootLayout:Landroid/widget/FrameLayout;
    ...
    iput-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mEmergencyCircleText:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mEmergencyCircleText:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mEmergencyCircleView:Lcom/android/keyguard/sec/EmergencyCircleView;

    invoke-virtual {v1, v2, v3, v3}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;II)V

    iget-object v1, p0, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;->mEmergencyCircleText:Landroid/widget/TextView;

    new-instance v2, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$3;

    invoke-direct {v2, p0}, Lcom/android/keyguard/KeyguardFaceVoiceUnlockView$3;-><init>(Lcom/android/keyguard/KeyguardFaceVoiceUnlockView;)V
