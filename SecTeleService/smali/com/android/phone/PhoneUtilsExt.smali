...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/android/phone/PhoneUtilsExt$7;-><init>()V
...
.method public static changeNetworkType4LongLife(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/telephony/TelephonyManager;->getDataStateDs(I)I
    ...
    invoke-static {v2, v0, v6}, Lcom/android/phone/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
...
.method static checkCallProtectionValue()Z
    ...
    const-string v2, "enable_call_protect_when_calling : null->1"
...
.method public static checkKTHDVoice()V
    ...
    invoke-virtual {v1, v5}, Lcom/android/phone/PhoneGlobals;->sendBroadcast(Landroid/content/Intent;)V

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "sendBroadcast HD_VOICE_CHANGED - "
    ...
    :cond_5
    const-string v5, "checkKTHDVoice : abnormal case"

    invoke-static {v5}, Lcom/android/phone/PhoneUtilsExt;->log(Ljava/lang/String;)V

    const-string v5, "backup_voicecall_type"
...
.method public static correctKTHDVoice()V
    ...
    invoke-static {v2, v3}, Lcom/android/phone/PhoneUtilsExt;->log(Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-static {v1}, Lcom/android/phone/PhoneUtilsExt;->setHDVoiceNetworkPref(Z)V
    ...
    const-string v0, "correctKTHDVoice : voicecall_type 2 => 0"
...
.method public static findAccessCode(Z)Z
    ...
    sput-object v1, Lcom/android/phone/PhoneUtilsExt;->mInternationalAccessCode:Ljava/lang/String;
...
.method public static getPhotoringAvailable(Lcom/android/internal/telephony/Connection;)Ljava/lang/String;
    ...
    const-string v2, "photoring_available"
    ...
    const-string v3, "getPhotoringAvailable reture : "
...
.method public static isCsVideoCall(Lcom/android/internal/telephony/Connection;)Z
    ...
    const-string v2, "isCsVideoCall: true"
...
.method public static isFindService()Ljava/lang/Boolean;
    ...
    :try_start_0
    const-string v4, "emergency_find_lost_phone_plus"
...
.method private static isLGTSIM()Z
    .locals 4
...
.method static notifyCallProtectionStatus(Lcom/android/phone/PhoneUtilsExt$CallProtectionType;Z)V
    .locals 7
    ...
    const-string v2, "notifyCallProtectionStatus : no change - "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    sget-object v2, Lcom/android/phone/PhoneUtilsExt;->mCallProtectionType:Lcom/android/phone/PhoneUtilsExt$CallProtectionType;
    ...
    const-string v6, "notifyCallProtectionStatus: "
    ...
    :cond_7
    :try_start_4
    sget-object v0, Lcom/android/phone/PhoneUtilsExt$CallProtectionType;->FOREGROUND:Lcom/android/phone/PhoneUtilsExt$CallProtectionType;
...
.method static notifyCallProtectionStatus(Z)V
    ...
    :cond_0
    sget-object v0, Lcom/android/phone/PhoneUtilsExt$CallProtectionType;->BACKGROUND:Lcom/android/phone/PhoneUtilsExt$CallProtectionType;
...
.method public static setDefaultPhoneApp(I)V
    ...
    const-string v1, "set Default PhoneApp : "
    ...
    invoke-virtual {v0}, Lcom/android/phone/PhoneGlobals;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    const-string v10, "com.skt.prod.dialer.activities.main.DialIntroActivity"

    invoke-direct {v1, v0, v10}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/content/ComponentName;

    const-string v10, "com.skt.prod.phone"

    const-string v11, "com.skt.prod.phone.activities.phone.OutgoingCallBroadcaster"

    invoke-direct {v0, v10, v11}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    invoke-static {v2, v3, v1}, Lcom/android/phone/PhoneUtilsExt;->internalSetDefaultPhoneApp(Landroid/content/IntentFilter;Landroid/content/Intent;Landroid/content/ComponentName;)V

    invoke-static {v6, v7, v1}, Lcom/android/phone/PhoneUtilsExt;->internalSetDefaultPhoneApp(Landroid/content/IntentFilter;Landroid/content/Intent;Landroid/content/ComponentName;)V

    invoke-static {v4, v5, v1}, Lcom/android/phone/PhoneUtilsExt;->internalSetDefaultPhoneApp(Landroid/content/IntentFilter;Landroid/content/Intent;Landroid/content/ComponentName;)V

    invoke-static {v8, v9, v0}, Lcom/android/phone/PhoneUtilsExt;->internalSetDefaultPhoneApp(Landroid/content/IntentFilter;Landroid/content/Intent;Landroid/content/ComponentName;)V

    return-void

    :cond_0
    const-string v0, "OEM Phone"
    ...
    const-string v11, "com.android.phone.OutgoingCallBroadcaster"
...
.method public static startRingForMe(Landroid/net/Uri;)V
    ...
    sget-object v2, Lcom/android/phone/PhoneUtilsExt;->sRingForMePlayer:Landroid/media/MediaPlayer;
    ...
    sput-object v2, Lcom/android/phone/PhoneUtilsExt;->sRingForMePlayer:Landroid/media/MediaPlayer;
    ...
    const-string v3, "Ringforme exception: "
...
.method public static updateAutoSpeakerOnState()V
    .locals 9
    ...
    invoke-virtual {v2}, Lcom/android/phone/PhoneGlobals;->getCGMvClient()Lcom/android/phone/CGMvClient;
    ...
    const-string v4, "button_auto_speaker_phone"
    ...
    const-string v6, "isAutoSpeakerOn : "
    ...
    invoke-virtual {v2, v8}, Lcom/android/phone/CGMvClient;->ServiceRegister(I)Z
    ...
    const-string v1, "Fail to register EG_MV_SERVICE_GRIP_TO_CHANGE_SPEAKER"
    ...
    :cond_2
    invoke-virtual {v2, v8}, Lcom/android/phone/CGMvClient;->ServiceUnregister(I)V

    invoke-static {v7}, Lcom/android/services/telephony/common/SystemDBInterface;->setGripToReceiverState(I)V
