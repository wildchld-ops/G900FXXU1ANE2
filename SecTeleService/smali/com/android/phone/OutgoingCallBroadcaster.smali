...
.method private startSipCallOptionHandler(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iput-object v1, p0, Lcom/android/phone/OutgoingCallBroadcaster;->newIntent:Landroid/content/Intent;
    ...
    invoke-static {p2, v1}, Lcom/android/phone/CallGatewayManager;->checkAndCopyPhoneProviderExtras(Landroid/content/Intent;Landroid/content/Intent;)V
    ...
    invoke-static {p2, v1}, Lcom/android/phone/PhoneUtils;->copyIMSExtras(Landroid/content/Intent;Landroid/content/Intent;)V
    ...
    const-string v2, "startSipCallOptionHandler, COMMON_VOLTE : true "

    const/4 v4, 0x1

    invoke-static {v1, v2, v4}, Lcom/android/phone/Log;->v(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    sput-boolean v0, Lcom/android/phone/PhoneUtilsExt;->mSkipSKTRADDialOption:Z

    const-string v0, "OutgoingCallBroadcaster"

    const-string v1, "startSipCallOptionHandler, isMMICode : true "
    ...
    const-string v1, "startSipCallOptionHandler, Not skt usim : true "
    ...
    const-string v1, "startSipCallOptionHandler, network_regist_videocall : true "
    ...
    const-string v1, "TPhone Mode : Inside Roaming Auto Dial type"
    ...
    const-string v1, "OEM Mode : Inside Roaming Auto Dial type"
    ...
    invoke-static {v1}, Lcom/android/phone/CallFeaturesSetting;->isVoLTECall(I)Z
    ...
    const-string v2, "hd_voice_network_pref"
    ...
    const-string v4, "3G HD Voice preferred = "
    ...
    const-string v1, "startSipCallOptionHandler(): call now"
    ...
    const-string v4, "Try to place video call, isImsRegistered - "
