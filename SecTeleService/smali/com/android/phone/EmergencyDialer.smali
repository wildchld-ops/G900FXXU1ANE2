...
.method private placeCall()V
    ...
    const-string v4, "CscFeature_VoiceCall_DialEmergNumAsNormalCall"
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/phone/EmergencyDialer;->isSwcEmergencyNumber(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v4, p0, v0}, Landroid/telephony/MultiSimPhoneNumberUtils;->isLocalEmergencyNumber(Ljava/lang/String;Landroid/content/Context;I)Z
    ...
    invoke-static {v4, p0}, Landroid/telephony/PhoneNumberUtils;->isLocalEmergencyNumber(Ljava/lang/String;Landroid/content/Context;)Z

    move-result v4

    if-nez v4, :cond_6

    const-string v4, "emergency_for_cyber_terror"
    ...
    :cond_4
    const-string v4, "china_cmcc_emergency_call"
...
.method private recreateEmergencyDialer()V
    ...
    invoke-static {v8, v13, v10}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
