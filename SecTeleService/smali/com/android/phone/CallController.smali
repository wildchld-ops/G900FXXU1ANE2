...
.method public placeCall(Landroid/content/Intent;)V
    ...
    const-string v25, "placeCall()...  "

    const/16 v26, 0x1

    invoke-static/range {v25 .. v26}, Lcom/android/phone/CallController;->log(Ljava/lang/String;Z)V
    ...
    invoke-static/range {v25 .. v27}, Lcom/android/phone/Log;->wtf(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    const-string v25, "feature_multisim"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/phone/PhoneGlobals;->getApplicationContext()Landroid/content/Context;
    ...
    const-string v25, "orange_first_Time_boot"
    ...
    const-string v25, "feature_chn_duos"
    ...
    const-string v26, "placeCall()... intent has simId, the active phone is... "
    ...
    const-string v25, "feature_chn_duos_cdma_gsm"
    ...
    const-string v26, "extra simNumber is wrong value. set correct simSlotID"
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/phone/PhoneGlobals;->getPhone(I)Lcom/android/internal/telephony/Phone;
    ...
    const-string v25, "sec_product_feature_common_dsds_support"
    ...
    invoke-static {v15, v0}, Landroid/telephony/PhoneNumberUtils;->isVoiceMailNumber(Ljava/lang/String;I)Z
    ...
    const-string v26, "voicemail=on"

    invoke-virtual/range {v25 .. v26}, Landroid/media/AudioManager;->setParameters(Ljava/lang/String;)V
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/phone/Log;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_b
    const-string v25, "intent has no extra simSlotID"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/phone/PhoneGlobals;->getCurrentNetworkPhone()Lcom/android/internal/telephony/Phone;
    ...
    :cond_c
    const-string v25, "ctc_dual_mode"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/phone/PhoneInterfaceManager;->getDefaultSimForVoiceCalls()I
    ...
    const-string v26, "placeCall()... intent has no simId, the active phone is... "
    ...
    :cond_15
    invoke-static {v15}, Landroid/telephony/PhoneNumberUtils;->isVoiceMailNumber(Ljava/lang/String;)Z
    ...
    :cond_19
    const-string v25, "emergency_call_cont_beeps"
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/media/AudioManager;->isWiredHeadsetOn()Z

    move-result v25

    if-eqz v25, :cond_20

    new-instance v25, Landroid/media/ToneGenerator;
    ...
    const-string v26, "==> placeCall(): status from placeCallInternal(): "
    ...
    sget-object v25, Lcom/android/phone/Constants$CallStatusCode;->OUT_OF_SERVICE:Lcom/android/phone/Constants$CallStatusCode;
    ...
    const-string v26, "CscFeature_CIQ_BroadcastState"
    ...
    invoke-static {v15, v0}, Lcom/android/internal/telephony/CallStateBroadcaster;->SendCallStatus(Ljava/lang/String;Lcom/android/internal/telephony/Call$State;)V

    const v25, 0xffff

    move/from16 v0, v25

    invoke-static {v15, v0}, Lcom/android/internal/telephony/CallStateBroadcaster;->SendCallDisconnected(Ljava/lang/String;I)V
    ...
    const-string v25, "android.phone.extra.CALL_TYPE"
    ...
    const-string v25, "atd"

    :goto_a
    const-string v26, "NO CARRIER"

    invoke-static/range {v25 .. v26}, Lcom/android/phone/ATCommandReceiver;->sendResponse(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v28, "Exception caught while creating local tone generator: "
    ...
    const-string v26, "call condition sucess iccid"
    ...
    const-string v26, "call condition sucess iccidPref"
    ...
    const-string v25, "orange newsim true"
