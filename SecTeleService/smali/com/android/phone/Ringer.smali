...
.field private final RESET_VOLUME:I

.field private final RETURN_ORIGIN_VOLUME:I

.field private final SIDE_TOUCH_VOLUME_RESET_DELAY:I
...
.field private mSidetouchOriginRingtoneVolume:I
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/phone/BluetoothManager;)V
    ...
    iput-wide v5, p0, Lcom/android/phone/Ringer;->mFirstRingEventTime:J

    iput-wide v5, p0, Lcom/android/phone/Ringer;->mFirstRingStartTime:J
    ...
    iput v4, p0, Lcom/android/phone/Ringer;->INVALID_VOLUME_LEVEL:I

    iput v4, p0, Lcom/android/phone/Ringer;->mSidetouchOriginRingtoneVolume:I
    ...
    iput v0, p0, Lcom/android/phone/Ringer;->RESET_VOLUME:I
    ...
    iput v0, p0, Lcom/android/phone/Ringer;->SIDE_TOUCH_VOLUME_RESET_DELAY:I
...
.method static synthetic access$400(Lcom/android/phone/Ringer;)I
    ...
    iget v0, p0, Lcom/android/phone/Ringer;->mSidetouchOriginRingtoneVolume:I
...
.method static synthetic access$402(Lcom/android/phone/Ringer;I)I
    ...
    iput p1, p0, Lcom/android/phone/Ringer;->mSidetouchOriginRingtoneVolume:I
...
.method static synthetic access$600(Lcom/android/phone/Ringer;Ljava/lang/String;)[J
    .locals 1
...
.method static synthetic access$700(Lcom/android/phone/Ringer;Z)V
    .locals 0
...
.method private registerLCDHover()V
    .locals 5
    ...
    const-string v2, "registerLCDHover"

    invoke-direct {p0, v2, v4}, Lcom/android/phone/Ringer;->log(Ljava/lang/String;Z)V

    const/16 v2, 0x9

    invoke-virtual {v0, v2}, Lcom/android/phone/CGMvClient;->ServiceRegister(I)Z
    ...
    const-string v3, "cGMvClient.ServiceRegister "
...
.method private unregisterLCDHover()V
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/phone/PhoneGlobals;->getCGMvClient()Lcom/android/phone/CGMvClient;

    move-result-object v0

    if-eqz v0, :cond_0

    const-string v1, "unregisterLCDHover"
    ...
    invoke-virtual {v0, v1}, Lcom/android/phone/CGMvClient;->ServiceUnregister(I)V

    const/4 v1, 0x0

    invoke-static {v1}, Lcom/android/services/telephony/common/SystemDBInterface;->setGripToSnoozeState(I)V
...
.method ringAfterDelay()V
    ...
    const-string v2, "ringAfterDelay()..."

    invoke-direct {p0, v2, v0}, Lcom/android/phone/Ringer;->log(Ljava/lang/String;Z)V
    ...
    const-string v2, "TPhone : Don\'t Start the ringtone and/or vibrator."
    ...
    :cond_4
    invoke-direct {p0}, Lcom/android/phone/Ringer;->registerLCDHover()V
    ...
    const-string v2, "check_ringtone_repeat"
    ...
    const-string v2, "/system/media/audio/ringtones/Beep_once.ogg"

    iget-object v3, p0, Lcom/android/phone/Ringer;->mCustomRingtoneUri:Landroid/net/Uri;

    invoke-direct {p0, v3}, Lcom/android/phone/Ringer;->getActualRingtonePath(Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string v2, "Ringtone does not repeat"
    ...
    iget v2, p0, Lcom/android/phone/Ringer;->mRingtoneAfterVib:I
    ...
    invoke-static {v2}, Lcom/android/phone/PhoneUtilsCommon;->isReadOutNotificatonOn(Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_6

    iget-boolean v2, p0, Lcom/android/phone/Ringer;->isStarredContact:Z
...
.method public setSidetouchOriginRingtoneVolume(I)V
    .locals 4
    ...
    const-string v1, "setSidetouchOriginRingtoneVolume : "
    ...
    const-string v0, "setSidetouchOriginRingtoneVolume: There is RETURN_ORIGIN_VOLUME, ignore current volume"

    invoke-direct {p0, v0, v2}, Lcom/android/phone/Ringer;->log(Ljava/lang/String;Z)V

    iget v0, p0, Lcom/android/phone/Ringer;->mOriginRingtoneVolume:I

    iput v0, p0, Lcom/android/phone/Ringer;->mSidetouchOriginRingtoneVolume:I

    :cond_0
    invoke-static {v2}, Lcom/android/services/telephony/common/SystemDBInterface;->setGripToSnoozeState(I)V
    ...
    iget v1, p0, Lcom/android/phone/Ringer;->mSidetouchOriginRingtoneVolume:I
...
.method stopRing()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/phone/Ringer;->unregisterLCDHover()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
