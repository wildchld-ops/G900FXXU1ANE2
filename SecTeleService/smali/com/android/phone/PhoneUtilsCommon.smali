...
.method public static disconnectRemoteContol()V
    .locals 3

    const-string v0, "disconnectRemoteContol"

    invoke-static {v0}, Lcom/android/phone/PhoneUtilsCommon;->log(Ljava/lang/String;)V
...
.method public static sendSMSAsBackground(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "sendSMSAsBackground. number : "
    ...
    new-instance v1, Lcom/android/phone/PhoneUtilsCommon$4;

    invoke-direct {v1, p2, p1, p0}, Lcom/android/phone/PhoneUtilsCommon$4;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
...
.method public static startPutDownListening(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/android/services/telephony/common/PhoneFeature;->hasPutUpDownMotionFeature(Landroid/content/Context;)Z
    ...
    :cond_1
    const-string v5, "startPutDownListening"

    invoke-static {v5, v8}, Lcom/android/phone/PhoneUtilsCommon;->log(Ljava/lang/String;Z)V
    ...
    sget-boolean v5, Lcom/android/phone/PhoneUtilsCommon;->sIsPutDownListening:Z
    ...
    sput-object v5, Lcom/android/phone/PhoneUtilsCommon;->sSContextManager:Landroid/hardware/scontext/SContextManager;

    sget-object v5, Lcom/android/phone/PhoneUtilsCommon;->sSContextManager:Landroid/hardware/scontext/SContextManager;
    ...
    sget-object v6, Lcom/android/phone/PhoneUtilsCommon;->sSContextListener:Landroid/hardware/scontext/SContextListener;

    const/16 v7, 0xf

    invoke-virtual {v5, v6, v7}, Landroid/hardware/scontext/SContextManager;->registerListener(Landroid/hardware/scontext/SContextListener;I)Z

    sput-boolean v8, Lcom/android/phone/PhoneUtilsCommon;->sIsPutDownListening:Z

    goto :goto_0

    :cond_2
    const-string v5, "getting sSContextManager failed"
