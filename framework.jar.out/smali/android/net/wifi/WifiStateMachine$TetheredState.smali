...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v3, v4}, Landroid/net/wifi/WifiStateMachine;->access$39600(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-static {v3, v4}, Landroid/net/wifi/WifiStateMachine;->access$40300(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$40400(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$40500(Landroid/net/wifi/WifiStateMachine;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$40600(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v3

    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$40700(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
