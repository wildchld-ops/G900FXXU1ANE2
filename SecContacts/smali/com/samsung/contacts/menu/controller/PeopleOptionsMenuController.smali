...
.method protected configureCommon(Landroid/view/Menu;II)V
    ...
    check-cast v40, Lcom/android/contacts/activities/PeopleActivity;

    invoke-virtual/range {v40 .. v40}, Lcom/android/contacts/activities/PeopleActivity;->isContactListEmpty()Z
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/contacts/activities/PeopleActivity;->isAddFavoriteListEmpty()Z
    ...
    :cond_0
    sget v40, Lcom/samsung/contacts/activities/ContactsTab;->DIALER:I
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/dialer/dialpad/DialpadFragment;->dialpadChooserVisible()Z
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/dialer/dialpad/DialpadFragment;->isDigitsEmpty()Z
    ...
    :goto_2
    invoke-interface/range {v39 .. v40}, Landroid/view/MenuItem;->setVisible(Z)Landroid/view/MenuItem;
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getOpStyleVariation()Ljava/lang/String;
    ...
    invoke-virtual/range {v40 .. v42}, Landroid/content/Context;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getEnablegeSurfingDialup()Z
    ...
    const-string v41, "gsm.operator.isroaming2"
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/dialer/dialpad/DialpadFragment;->getDigitsWidget()Landroid/widget/EditText;
    ...
    :cond_10
    sget v40, Lcom/samsung/contacts/activities/ContactsTab;->CALLLOG:I
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/contacts/activities/PeopleActivity;->isCallLogListEmpty()Z
    ...
    const-string v40, "RecordingAllowed"

    invoke-static {}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getInstance()Lcom/samsung/contacts/util/LoadCscFeatureUtils;

    move-result-object v41

    invoke-virtual/range {v41 .. v41}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getEnableVoiceCallRecording()Ljava/lang/String;
    ...
    invoke-static/range {v40 .. v40}, Lcom/android/contacts/ContactsUtils;->isUltraPowerSavingMode(Landroid/content/Context;)Z
    ...
    :cond_14
    sget v40, Lcom/samsung/contacts/activities/ContactsTab;->ALL:I
    ...
    invoke-interface/range {v40 .. v41}, Landroid/view/MenuItem;->setShowAsAction(I)V
    ...
    invoke-static/range {v40 .. v40}, Lcom/android/contacts/ContactsUtils;->isSendEmailActionAvailable(Landroid/content/Context;)Z

    move-result v40

    if-eqz v40, :cond_1a

    const v40, 0x7f0e025c
    ...
    :cond_1b
    sget v40, Lcom/samsung/contacts/activities/ContactsTab;->FAVORITES:I
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/contacts/activities/PeopleActivity;->isFavoriteListEmpty()Z
