...
.method private doSaveAction()V
    ...
    invoke-static {v1}, Lcom/android/contacts/common/list/CustomContactListFilterActivity$DisplayAdapter;->access$600(Lcom/android/contacts/common/list/CustomContactListFilterActivity$DisplayAdapter;)Lcom/android/contacts/common/list/CustomContactListFilterActivity$AccountSet;
...
.method public getCustomActionLayout()Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mActionBar:Landroid/app/ActionBar;
...
.method public onChildClick(Landroid/widget/ExpandableListView;Landroid/view/View;IIJ)Z
    ...
    iget-object v2, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mAdapter:Lcom/android/contacts/common/list/CustomContactListFilterActivity$DisplayAdapter;

    invoke-virtual {v2, p3, p4}, Lcom/android/contacts/common/list/CustomContactListFilterActivity$DisplayAdapter;->getChild(II)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Lcom/android/contacts/common/list/CustomContactListFilterActivity$GroupDelta;->putVisible(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mList:Landroid/widget/ExpandableListView;

    iget-object v0, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mList:Landroid/widget/ExpandableListView;
    ...
    iput-object v0, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mAdapter:Lcom/android/contacts/common/list/CustomContactListFilterActivity$DisplayAdapter;
    ...
    iput-object v0, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mActionBar:Landroid/app/ActionBar;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    iget-object v1, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mActionBar:Landroid/app/ActionBar;
    ...
    iput-object v1, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mcancelButton:Landroid/widget/Button;

    iget-object v1, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mcancelButton:Landroid/widget/Button;

    new-instance v2, Lcom/android/contacts/common/list/CustomContactListFilterActivity$5;

    invoke-direct {v2, p0}, Lcom/android/contacts/common/list/CustomContactListFilterActivity$5;-><init>(Lcom/android/contacts/common/list/CustomContactListFilterActivity;)V
    ...
    iput-object v1, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mSaveButton:Landroid/widget/Button;

    iget-object v1, p0, Lcom/android/contacts/common/list/CustomContactListFilterActivity;->mSaveButton:Landroid/widget/Button;

    new-instance v2, Lcom/android/contacts/common/list/CustomContactListFilterActivity$6;

    invoke-direct {v2, p0}, Lcom/android/contacts/common/list/CustomContactListFilterActivity$6;-><init>(Lcom/android/contacts/common/list/CustomContactListFilterActivity;)V
