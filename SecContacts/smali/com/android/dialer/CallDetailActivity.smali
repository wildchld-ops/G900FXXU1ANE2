...
.field private mContactPhotoView:Lcom/samsung/contacts/widget/ContactPhotoView;
...
.field private mIsClickedDialBtn:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v3, p0, Lcom/android/dialer/CallDetailActivity;->mIsClickedDialBtn:Z
...
.method private configureCallButton(Lcom/android/dialer/CallDetailActivity$ViewEntry;I)V
    ...
    iget-object v0, p0, Lcom/android/dialer/CallDetailActivity;->mPrimaryActionListener:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {v0, v1}, Lcom/android/dialer/calllog/PhoneNumberHelper;->canSendSmsTo(Ljava/lang/CharSequence;)Z
...
.method private loadContactPhotos(Landroid/net/Uri;JZ)V
    ...
    invoke-direct {p0, v0}, Lcom/android/dialer/CallDetailActivity;->setContactImageLayout(Z)V
    ...
    iget-object v1, p0, Lcom/android/dialer/CallDetailActivity;->mContactPhotoView:Lcom/samsung/contacts/widget/ContactPhotoView;

    iget-object v2, p0, Lcom/android/dialer/CallDetailActivity;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1, v2}, Lcom/samsung/dialer/util/CallDetailDrawableSetter;-><init>(Lcom/samsung/contacts/widget/ContactPhotoView;Landroid/content/Context;)V

    invoke-virtual {p0}, Lcom/android/dialer/CallDetailActivity;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/dialer/util/CallDetailDrawableSetter;->setResources(Landroid/content/res/Resources;)V

    iget-object v1, p0, Lcom/android/dialer/CallDetailActivity;->mContactPhotoView:Lcom/samsung/contacts/widget/ContactPhotoView;

    invoke-virtual {v0, p1, p2, p3, v1}, Lcom/samsung/dialer/util/CallDetailDrawableSetter;->setupPhoto(Landroid/net/Uri;JLcom/samsung/contacts/widget/ContactPhotoView;)V
    ...
    iget-object v0, p0, Lcom/android/dialer/CallDetailActivity;->mContactPhotoView:Lcom/samsung/contacts/widget/ContactPhotoView;

    invoke-virtual {v0}, Lcom/samsung/contacts/widget/ContactPhotoView;->isShown()Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    check-cast v2, Lcom/samsung/contacts/widget/ContactPhotoView;

    iput-object v2, p0, Lcom/android/dialer/CallDetailActivity;->mContactPhotoView:Lcom/samsung/contacts/widget/ContactPhotoView;
...
.method protected onPause()V
    ...
    iget-boolean v0, p0, Lcom/android/dialer/CallDetailActivity;->mIsClickedDialBtn:Z
...
.method public setIsClickedDialBtn()V
    .locals 1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/dialer/CallDetailActivity;->mIsClickedDialBtn:Z
