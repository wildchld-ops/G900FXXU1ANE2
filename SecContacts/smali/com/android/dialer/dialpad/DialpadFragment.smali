...
# instance fields
.field private final DONT_TOUCH_AREA:I

.field private DONT_TOUCH_AREA_PIXEL:I
...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/dialer/dialpad/DialpadFragment;->DONT_TOUCH_AREA:I
...
.method private ignoreKeypadTouchArea(Landroid/view/View;Landroid/view/MotionEvent;)Z
    .locals 6
    ...
    const-string v5, ", DONT_TOUCH_AREA_PIXEL : "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/dialer/dialpad/DialpadFragment;->DONT_TOUCH_AREA_PIXEL:I
    ...
    iget v5, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenWidth:I
    ...
    iget v5, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenHeight:I
    ...
    iget v3, p0, Lcom/android/dialer/dialpad/DialpadFragment;->DONT_TOUCH_AREA_PIXEL:I
    ...
    :cond_1
    iget v3, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenWidth:I

    iget v4, p0, Lcom/android/dialer/dialpad/DialpadFragment;->DONT_TOUCH_AREA_PIXEL:I

    sub-int/2addr v3, v4

    if-gt v1, v3, :cond_0

    iget v1, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenHeight:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/android/dialer/dialpad/DialpadFragment;->ignoreKeypadTouchArea(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method protected setEditTextView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigitsContainer:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;
    ...
    invoke-virtual {v0, p0}, Lcom/android/dialer/dialpad/EllipsisTextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    invoke-virtual {v0, p0}, Lcom/android/dialer/dialpad/EllipsisTextView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    invoke-virtual {v0, p0}, Lcom/android/dialer/dialpad/EllipsisTextView;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->setScaledWidth(F)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    sget-object v2, Lcom/android/contacts/ContactsApplication;->ttfEditTextTypeface:Landroid/graphics/Typeface;

    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->setTypeface(Landroid/graphics/Typeface;)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    iget v2, v1, Landroid/util/DisplayMetrics;->density:F

    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->setScaledDensity(F)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    invoke-virtual {v0, p0}, Lcom/android/dialer/dialpad/EllipsisTextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mDigits:Lcom/android/dialer/dialpad/EllipsisTextView;

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->forceHideSoftInput(Z)V

    invoke-static {}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getInstance()Lcom/samsung/contacts/util/LoadCscFeatureUtils;

    move-result-object v0

    invoke-virtual {v0}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getDisablePhoneNumberFormatting()Z
    ...
    invoke-static {v0, v2}, Lcom/android/contacts/common/util/PhoneNumberFormatter;->setPhoneNumberFormattingTextWatcher(Landroid/content/Context;Landroid/widget/TextView;)V
    ...
    iput v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenWidth:I
    ...
    iput v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mScreenHeight:I
    ...
    iput v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->DONT_TOUCH_AREA_PIXEL:I
    ...
    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->setFontSize(I)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/dialer/dialpad/EllipsisTextView;->setMaxTextSize(F)V
    ...
    invoke-virtual {v3}, Lcom/android/dialer/dialpad/EllipsisTextView;->getFontSizeRatio()D
    ...
    invoke-virtual {v0, v1}, Lcom/android/dialer/dialpad/EllipsisTextView;->setMinTextSize(F)V
    ...
    iput-object v0, p0, Lcom/android/dialer/dialpad/DialpadFragment;->mRecipients:Landroid/widget/EditText;
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/dialer/impl/DialpadImpl;->setLocalName(Landroid/text/Editable;)V
