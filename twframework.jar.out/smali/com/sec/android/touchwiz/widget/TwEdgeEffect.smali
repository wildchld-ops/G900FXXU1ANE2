...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->customAPI:Z

    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mState:I

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mBounds:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdge:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v1

    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdgeHeight:I

    iget-object v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlow:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v1

    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowHeight:I
    ...
    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowWidth:I

    iget v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowHeight:I

    int-to-float v1, v1

    mul-float/2addr v1, v4

    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowHeight:I

    int-to-float v2, v2

    mul-float/2addr v1, v2

    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowWidth:I
    ...
    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mMaxEffectHeight:I
...
.method public draw(Landroid/graphics/Canvas;)Z
    ...
    iget-object v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlow:Landroid/graphics/drawable/Drawable;

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowAlpha:F
    ...
    iget v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowHeight:I

    int-to-float v5, v5

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowScaleY:F

    mul-float/2addr v5, v6

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowHeight:I

    int-to-float v6, v6

    mul-float/2addr v5, v6

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlowWidth:I
    ...
    iget v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mWidth:I

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mMinWidth:I
    ...
    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mWidth:I
    ...
    iget-object v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdge:Landroid/graphics/drawable/Drawable;

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdgeAlpha:F
    ...
    iget v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdgeHeight:I

    int-to-float v5, v5

    iget v6, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdgeScaleY:F
    ...
    iput v5, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mWidth:I

    iput v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mOffsetX:I
    ...
    iput v4, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mState:I
    ...
    iput v4, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mOffsetX:I
...
.method public getBounds(Z)Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mBounds:Landroid/graphics/Rect;

    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mWidth:I

    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mMaxEffectHeight:I

    invoke-virtual {v1, v0, v0, v2, v3}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mBounds:Landroid/graphics/Rect;

    iget v2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mX:I

    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mOffsetX:I

    add-int/2addr v2, v3

    iget v3, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mY:I

    if-eqz p1, :cond_0

    iget v0, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mMaxEffectHeight:I
    ...
    iget-object v0, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mBounds:Landroid/graphics/Rect;
...
.method public onPull(F)V
    ...
    iget-boolean v4, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->customAPI:Z
...
.method setPosition(II)V
    ...
    iput p1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mX:I

    iput p2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mY:I
...
.method public setTouchWizCustomization(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->customAPI:Z

    iput-object p1, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mEdge:Landroid/graphics/drawable/Drawable;

    iput-object p2, p0, Lcom/sec/android/touchwiz/widget/TwEdgeEffect;->mGlow:Landroid/graphics/drawable/Drawable;
